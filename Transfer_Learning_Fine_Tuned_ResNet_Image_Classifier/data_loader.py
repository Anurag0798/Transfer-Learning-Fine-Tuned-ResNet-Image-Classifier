...
# Loading image processor for ResNet model
...
def preprocess_image(image, label):
    ...
    # Manually setting expected shape
...
def load_datasets(train_dir, val_dir):
    ...
    # Unbatching, preprocessing each image, then batching again
